...
namespace R6S_Custom_Game_Tool
{
    ...
    internal class MemoryEngine
    {
        ...
        public EngineStartData startMemEngine()
        {
            ...
            try
            {
                ...
                if (iProcID == 0)
                {
                    ...
                    GameManager = "RainbowSix.exe+0x605D1C0";
                    RoundManager = "RainbowSix.exe+0x60737B8";
                    NetworkManager = "RainbowSix.exe+0x69CCFF0";
                    IsRunning = "DirectX";
                }
        ...
        static bool isNotShied(string weapon)
        {
            return weapon != "EditMe" && weapon != "EditMe" && weapon != "EditMe" && weapon != "EditMe";
        }

        static bool isNotClashShied(string weapon)
        {
            return weapon != "EditMe";
        }
        ...
        public void randomizeAll()
        {
            ...
            string[] WeaponsP = Array.FindAll(Weapons, isNotClashShied).ToArray();
            string[] WeaponsS = Array.FindAll(Weapons, isNotShied).ToArray();
            try
            {
                for (int j = 0; j < 10; j++)
                {
